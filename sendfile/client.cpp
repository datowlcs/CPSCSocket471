...
//	cout << "This is x" << x << endl;
		if(x=="put"){		
						...
						char* confirmedRecv[50];
						valread = read(connfd, confirmedRecv, 50);
						cout << "This is the buffer: "<< confirmedRecv << endl;
						/* Close the file */
						close(fd);
					}
			else if(x=="ls"){
